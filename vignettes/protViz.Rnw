...
\author{Christian Panse\\Functional Genomics Center Zurich
  \And Jonas Grossmann\\Functional Genomics Center Zurich}
...
text(mass, hydrophobicity, fetuin, pos=3, cex=0.5)
@
